...
//     version 1.3.0
//     from Assets/Resources/Configs/XRI Input Actions.inputactions
//
...
public partial class @XRIInputActions : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""XRI Other"",
            ""id"": ""b4f0c693-290e-41cd-bdb7-896d520a6929"",
            ""actions"": [
                {
                    ""name"": ""Menu"",
                    ""type"": ""Button"",
                    ""id"": ""b4df6eb0-81c2-498e-a43e-733205739485"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""fec509fe-1ec8-4339-b42a-e30af046267c"",
                    ""path"": ""*/{MenuButton}"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""b3385fe5-adae-4361-aeb6-e8ac199e5075"",
    ...
    ""controlSchemes"": [
        ...
        // XRI Other
        m_XRIOther = asset.FindActionMap("XRI Other", throwIfNotFound: true);
        m_XRIOther_Menu = m_XRIOther.FindAction("Menu", throwIfNotFound: true);
    }
    ...
    // XRI Other
    private readonly InputActionMap m_XRIOther;
    private IXRIOtherActions m_XRIOtherActionsCallbackInterface;
    private readonly InputAction m_XRIOther_Menu;
    public struct XRIOtherActions
    {
        private @XRIInputActions m_Wrapper;
        public XRIOtherActions(@XRIInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @Menu => m_Wrapper.m_XRIOther_Menu;
        public InputActionMap Get() { return m_Wrapper.m_XRIOther; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(XRIOtherActions set) { return set.Get(); }
        public void SetCallbacks(IXRIOtherActions instance)
        {
            if (m_Wrapper.m_XRIOtherActionsCallbackInterface != null)
            {
                @Menu.started -= m_Wrapper.m_XRIOtherActionsCallbackInterface.OnMenu;
                @Menu.performed -= m_Wrapper.m_XRIOtherActionsCallbackInterface.OnMenu;
                @Menu.canceled -= m_Wrapper.m_XRIOtherActionsCallbackInterface.OnMenu;
            }
            m_Wrapper.m_XRIOtherActionsCallbackInterface = instance;
            if (instance != null)
            {
    ...
    public XRIOtherActions @XRIOther => new XRIOtherActions(this);
    ...
    public interface IXRIOtherActions
    {
